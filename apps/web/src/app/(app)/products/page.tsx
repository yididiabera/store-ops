...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  const { metrics, products, options } = await getProductsPageData();
      ...
      <section className="surface-panel rounded-[1.2rem]">
            ...
            <form className="grid gap-3 lg:grid-cols-[minmax(15rem,2fr)_minmax(10rem,1fr)_minmax(4.5rem,auto)] lg:items-end">
              ...
              <label className="min-w-0 space-y-1.5">
                ...
                >
                  ...
                  {(options?.categories ?? productCategoryOptions).map((category) => (
          ...
          <div className="flex items-center justify-between gap-4 border-b border-[color:var(--line)] px-5 py-4 sm:px-6">
            ...
            <div className="flex items-center gap-3">
              <NewProductModal
                productCategoryOptions={options?.categories ?? productCategoryOptions}
                productStatusOptions={options?.statuses ?? productStatusOptions}
              />
                    ...
                    >
                      ...
                      <div className="space-y-2 min-w-0">
                        ...
                        <select
                          ...
                          className="premium-select"
                        >
                          {(options?.statuses ?? productStatusOptions).map((status) => (
